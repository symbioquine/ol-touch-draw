...
class TouchDrawFeatureDraftingState extends BaseObject__default['default'] {
  ...
  constructor(opt_options) {
    ...
    const draftFeature = new Feature__default['default']({
      geometry: new geom.Polygon([[...originalSegmentCoords, ...originalSegmentCoords, originalSegmentCoords[0]]], 'XY'),
    });
    ...
    const recalculateDraftFeatureGeometry = () => {
      const newGeom = new geom.Polygon([[...originalSegmentCoords, ...originalSegmentCoords, originalSegmentCoords[0]]], 'XY');
