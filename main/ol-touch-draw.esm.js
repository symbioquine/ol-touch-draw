...
import { containsCoordinate, getBottomLeft, getTopRight, getTopLeft, getBottomRight, getSize, buffer, boundingExtent, getCenter, isEmpty } from 'ol/extent';
 ...
 */
class TouchDrawEvent extends Event {
  /**
...
function createAlwaysVisibleVectorSource() {
  const vectorSource = new Vector$1({
...
export default TouchDraw;
export { DefaultTouchDrawUnitConversions };
